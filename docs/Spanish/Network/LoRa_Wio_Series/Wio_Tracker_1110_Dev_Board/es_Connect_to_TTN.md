...
[The Things Stack (TTS)](https://www.thethingsnetwork.org/) es una pila de servidor de red LoRaWAN®, el componente crítico para cualquier solución LoRaWAN.  
En este capítulo te guiaremos para conectar la placa de desarrollo Wio Tracker 1110 a The Things Network.


## Configurar la Placa de Desarrollo


Antes de conectarte a TTS, necesitas configurar los parámetros básicos de tu placa desde la aplicación SenseCAP Mate. Consulta la sección [Primeros Pasos](https://wiki.seeedstudio.com/Get_Started_with_Wio-Trakcer_1110/#configure-the-frequency-and-connect-to-the-gateway) para más detalles.

* Establece la plataforma en `TTN` y copia los siguientes datos: `Device EUI`, `APP EUI` y `APP Key`.
...
Ingresa un **ID de aplicación** y haz clic en **Crear aplicación** para guardar los cambios.

<p style={{textAlign: 'center'}}><img src="https://files.seeedstudio.com/wiki/SenseCAP/Wio-WM1110%20Dev%20Kit/create_application1.png" alt="pir" width={800} height="auto" /></p>

### Paso 2: Registrar el dispositivo

Pega el `Device EUI` / `APP EUI` / `APP Key`, selecciona el `plan de frecuencia` de acuerdo con tu dispositivo y luego haz clic en `Registrar dispositivo final`.
...
:::tip
El `JoinEUI` anteriormente se llamaba `AppEUI`, son lo mismo.
:::

### Paso 3: Configurar el decodificador

Ve a `Formateadores de carga útil`, selecciona el tipo de formateador como `Formateador Javascript personalizado`, y luego copia el siguiente código:
...
Cuando el dispositivo intente conectarse a la red, la luz de respiración parpadeará. Si el dispositivo se une a la red correctamente, la luz de respiración parpadeará rápidamente y se escuchará una melodía alegre y brillante.

Luego podrás verificar los datos en la consola de TTS.
...
[Decodificador TTN para Wio Tracker 1110 Dev Board](https://github.com/Seeed-Solution/SenseCAP-Decoder/blob/main/WM1110/TTN/SenseCAP_WM1110_TTN_Decoder.js)
