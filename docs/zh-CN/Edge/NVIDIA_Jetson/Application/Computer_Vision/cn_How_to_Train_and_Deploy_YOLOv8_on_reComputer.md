...
有许多平台可以免费下载数据集，例如 [Roboflow](https://roboflow.com/)、[Kaggle](https://www.kaggle.com/) 等。这里，我们从 Kaggle 下载了一个与交通场景相关的标注数据集 [Traffic Detection Project](https://www.kaggle.com/datasets/yusufberksardoan/traffic-detection-project/download?datasetVersionNumber=1)。
...
为了演示，我从 [YouTube](https://www.youtube.com/watch?v=iJZcjZD0fw0) 捕获并保存了三张图片，并尝试使用 [Label Studio](https://www.youtube.com/watch?v=iJZcjZD0fw0) 对这些图片进行标注。
...
接下来是漫长的等待过程。考虑到等待过程中可能会关闭远程连接窗口，本教程使用 
