...
<table align="center">
  ...
  <tr>
    <td><div className="get_one_now_container" style={{textAlign: 'center'}}>
      <a className="get_one_now_item" href="https://www.seeedstudio.com/Seeed-XIAO-ESP32C3-p-5431.html">
      <strong><span><span style={{color: 'FFFFFF', fontSize: '1.2em'}}> Get One Now 🖱️</span></span></strong>
      </a>
    </div></td>
    <td><div className="get_one_now_container" style={{textAlign: 'center'}}>
      <a className="get_one_now_item" href="https://www.seeedstudio.com/Grove-Shield-for-Seeeduino-XIAO-p-4621.html">
      <strong><span><span style={{color: 'FFFFFF', fontSize: '1.2em'}}> Get One Now 🖱️</span></span></strong>
      </a>
    </div></td>
          <td><div className="get_one_now_container" style={{textAlign: 'center'}}>
      <a className="get_one_now_item" href="https://www.seeedstudio.com/Grove-Temp-Humi-Sensor-SHT40-p-5384.html">
      <strong><span><span style={{color: 'FFFFFF', fontSize: '1.2em'}}> Get One Now 🖱️</span></span></strong>
      </a>
    </div></td>
  </tr>
