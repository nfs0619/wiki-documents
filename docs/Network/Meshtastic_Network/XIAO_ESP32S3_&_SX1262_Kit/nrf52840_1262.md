...
| **Power** | **Input Voltage:**  <br /> - Type-C: 5V  <br /> - Battery (BAT): 4.2V  <br /> **Battery Charging Current:** 50mA / 100mA  <br /> **Standby Power Consumption:** less than 5µA |  
...
The GPS module will always be active and will not sleep, consuming an average of 30mA.
Pressing the button will restart the GPS module.
