...
:::note
We recommend using u-center 2, the software is more versatile and less laggy.
:::
...
:::tip
If you are using u-center 2, then you can skip the following steps, all these features are integrated in u-center 2.
