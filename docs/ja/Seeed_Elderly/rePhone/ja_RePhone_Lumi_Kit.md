...
<!-- まず、**[Arduino IDE for RePhone Kit](/Arduino_IDE_for_RePhone_Kit "Arduino IDE for RePhone Kit")** の指示に従い、RePhone Kit用のArduino IDEをダウンロードし、ドライバーをインストールしてください。 -->
...
## リソース
---
<!-- 詳細については、Wikiページ [Xadow Duino](/Xadow_Duino) をご覧ください。 -->
