---
description: 使用 reTerminal 和 Pi 摄像头结合 OpenCV 的入门教程
title: 使用 reTerminal 和 Pi 摄像头结合 OpenCV 的入门教程
keywords:
  - Edge
  - reTerminal 
  - piCamera
...
我们建议从官方网站安装 **Bullseye** 或 **Bookworm** 版本的 Raspberry Pi 64 位操作系统。如果您希望安装新的 Raspbian OS，请按照此 [**指南**](https://wiki.seeedstudio.com/reTerminal/#flash-raspberry-pi-os-64-bit-ubuntu-os-or-other-os-to-emmc) 中的步骤操作。
