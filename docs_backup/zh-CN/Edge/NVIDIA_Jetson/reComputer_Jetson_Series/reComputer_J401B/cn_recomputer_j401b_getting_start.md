---
description: reComputer J401B 是一款紧凑型高性能边缘 AI 设备，搭载 NVIDIA Jetson Orin 模块，提供丰富的 I/O 接口，并支持 JetPack 5.1.3 至 6.2，用于多种 AI 应用。本指南涵盖其规格、刷机说明以及接口使用方法，适用于开发和部署。
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td colspan='2' align='center'>1024 核 NVIDIA Ampere 架构 GPU，带 32 个 Tensor 核心</td>
    </tr>
    <tr>
      <td>GPU 最大频率</td>
    ...
    <tr>
      <td>视频编码器</td>
      <td colSpan='2' align='center'>支持 1-2 个 CPU 核心的 1080p30</td>
    ...
    <tr>
      <td>RTC</td>
      <td colSpan='4' align='center'>RTC 2 针，RTC 插座（支持 CR1220，但不包含）</td>
    </tr>
    <tr>
      <td>电源</td>
...
在这里，我们将向您展示如何将 [Jetpack](https://developer.nvidia.com/embedded/jetpack) 刷写到连接到 reComputer J4012B/ J4011B/ J3010B 和 J3011B 的 NVMe SSD 上。这些设备均内置 J401B 载板，刷写步骤对于所有设备都是相同的。
...
**步骤 1:** 在主机电脑上[下载](https://developer.nvidia.com/embedded/jetson-linux-r3531) NVIDIA 驱动程序。所需的驱动程序如下所示：
...
**步骤 1：** [下载](https://developer.nvidia.com/embedded/jetson-linux-r3541) NVIDIA 驱动到主机 PC。所需的驱动如下所示：
...
现在我们需要应用 NVIDIA 提供的补丁，该补丁是 JP5.1.2 所需的，详细说明见 [这里](https://docs.nvidia.com/jetson/archives/r35.4.1/ReleaseNotes/Jetson_Linux_Release_Notes_r35.4.1.pdf)，位于官方 NVIDIA JetPack 发布说明的第 4.2.3 节。
...
在 Ubuntu 主机上打开终端并运行命令 `sha256sum <File>` 来获取下载文件的 SHA256 哈希值。如果结果哈希值与 Wiki 中提供的 SHA256 哈希值匹配，则说明您下载的固件是完整且未损坏的。
:::
...
<table style={{textAlign: 'center'}}>
  ...
  <tbody>
    <tr>
      <td>Orin NX 16GB</td>
      <td>
        <a href="https://seeedstudio88-my.sharepoint.com/:u:/g/personal/youjiang_yu_seeedstudio88_onmicrosoft_com/EavQHXoSEg9PuLs4vuujXLcB0-GW6Ti1zHGL2UHzgS6TWg?e=J7oRrf" target="_blank" rel="noopener noreferrer">下载
        </a>
      </td>
      <td>
    ...
    <tr>
      <td>Orin NX 8GB</td>
      <td>
      <a href="https://seeedstudio88-my.sharepoint.com/:u:/g/personal/youjiang_yu_seeedstudio88_onmicrosoft_com/EcfUdbmSiOBFo_Po-Cui3jkBDORKexZ4S43Jde5XApqdeQ?e=zqealW" target="_blank" rel="noopener noreferrer">下载
      </a>
      </td>
      <td>
    ...
    <tr>
      <td>Orin Nano 8GB</td>
      <td>
      <a href="https://seeedstudio88-my.sharepoint.com/:u:/g/personal/youjiang_yu_seeedstudio88_onmicrosoft_com/EauK-aXvruxHsC1-bAmTwZkBNB0PsvPX6S6oV4Q1UrAUFw?e=rytWvU" target="_blank" rel="noopener noreferrer">下载
      </a>
      </td>
      <td>
    ...
    <tr>
      <td>Orin Nano 4GB</td>
      <td>
      <a href="https://seeedstudio88-my.sharepoint.com/:u:/g/personal/youjiang_yu_seeedstudio88_onmicrosoft_com/EcHfrgY9GxVNiwGh6YTB50cBCc5QcKgnGpTZQfv94x4VNw?e=Rl73Zh" target="_blank" rel="noopener noreferrer">下载
      </a>
      </td>
      <td>
...
在 Ubuntu 主机上打开终端，运行命令 `sha256sum <File>` 来获取下载文件的 SHA256 哈希值。如果生成的哈希值与 Wiki 中提供的 SHA256 哈希值匹配，则说明您下载的固件是完整且未损坏的。
:::
...
<table style={{textAlign: 'center'}}>
  ...
  <tbody>
    <tr>
      <td>Orin NX 16GB</td>
      <td>
        <a href="https://seeedstudio88-my.sharepoint.com/:u:/g/personal/youjiang_yu_seeedstudio88_onmicrosoft_com/EWCZOBNb9C9AoZe-mt23jLABZk942Lf0yopVGFJFTeL5DA?e=o7epES" target="_blank" rel="noopener noreferrer">下载
        </a>
      </td>
    ...
    <tr>
      <td>Orin NX 8GB</td>
      <td>
        <a href="https://seeedstudio88-my.sharepoint.com/:u:/g/personal/youjiang_yu_seeedstudio88_onmicrosoft_com/EcvDRK7qgWhGty_H-P7yHZ8Bob3v9AEs_vFVd-zOC3WX5w?e=FmlfjD" target="_blank" rel="noopener noreferrer">下载
        </a>
      </td>
    ...
    <tr>
      <td>Orin Nano 8GB</td>
      <td>
        <a href="https://seeedstudio88-my.sharepoint.com/:u:/g/personal/youjiang_yu_seeedstudio88_onmicrosoft_com/EeO8T8kNkpZGl9W2QfmnKYQBeXB8-M88aZWLMvPP7uARcA?e=fBuClA" target="_blank" rel="noopener noreferrer">下载
        </a>
      </td>
    ...
    <tr>
      <td>Orin Nano 4GB</td>
      <td>
        <a href="https://seeedstudio88-my.sharepoint.com/:u:/g/personal/youjiang_yu_seeedstudio88_onmicrosoft_com/EY01pL5oq0FAmavoRY_p9DMBj4t-LHzRtEAh1UBQen3S3g?e=jUfauO" target="_blank" rel="noopener noreferrer">下载
        </a>
      </td>
...
<table style={{textAlign: 'center'}}>
  ...
  <tbody>
    <tr>
      <td>Orin Nano 8GB</td>
      <td>
        <a href="https://seeedstudio88-my.sharepoint.com/:u:/g/personal/youjiang_yu_seeedstudio88_onmicrosoft_com/Ea8wqK7OE0VGtclEw1J0FIYB8I6qJEH_n1facfwl9AlhkQ?e=UoHjcf" target="_blank" rel="noopener noreferrer">下载
        </a>
      </td>
    ...
    <tr>
      <td>Orin Nano 4GB</td>
      <td>
        <a href="https://seeedstudio88-my.sharepoint.com/:u:/g/personal/youjiang_yu_seeedstudio88_onmicrosoft_com/EYuzr4pFfZ5Lp2WIqG_tZ7ABIYU9A0KuFl1nAs9FiGmZBQ?e=WALXR5" target="_blank" rel="noopener noreferrer">下载
        </a>
      </td>
...
:::note
请注意，由于启用 `超级模式` 后功耗和热量增加，[reComputer J4011B](https://www.seeedstudio.com/reComputer-J4011B-p-6407.html) 和 [reComputer J4012B](https://www.seeedstudio.com/reComputer-J4012B-p-6406.html) 无法在最高模式下稳定运行。因此，此更新不包括这两款产品。
