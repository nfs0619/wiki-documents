...
<div class="independent_container">
    <div class="independent_item" style={{textAlign: 'left'}}>
            ...
            <br/>
            <a href="/Mender-Client-dual-GbE-CM4" target="_blank"><span><font color={'FFFFFF'} size={"2"}> アプリケーション: reRouterでのMenderの使用 </font></span></a>
    </div>
    <div class="independent_item" style={{textAlign: 'left'}}>
...
<div class="intro_container">
    ...
    <div class="intro_item" style={{textAlign: 'center'}}>
            ...
            <br/>
            <a href="/Grove-I2C_FM_Receiver" target="_blank"><span><font color={'FFFFFF'} size={"2"}> 周波数変調レシーバー </font></span></a>
            <br/>
    </div>
</div>
...
<div class="intro_container">
    <div class="intro_item" style={{textAlign: 'center'}}>
            ...
            <br/>
            <a href="/WiFi_Serial_Transceiver_Module" target="_blank"><span><font color={'FFFFFF'} size={"2"}> WiFi シリアルトランシーバーモジュール</font></span></a>
            <br/>
            <a href="/2KM_Long_Range_RF_link_kits_w_encoder_and_decoder" target="_blank"><span><font color={'FFFFFF'} size={"2"}> 2KM 長距離 RF リンクキット（エンコーダーおよびデコーダー付き）</font></span></a>
            <br/>
    </div>
</div>